...
public class LimitCheck {
    ...
    public static void adminLimitCheck() {
    	
        String prohibitedItemsFilePath = "C:\\git\\Daitso\\prohibited_items.txt"; // 금지물품 파일 경로

        LimitManager prohibitedItemsManager = new LimitManager(prohibitedItemsFilePath);
        ...
        while (true) {
            ...
            case 0:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    String filePath = "C:\\git\\Daitso\\prohibited_items.txt"; 
                    String fileContent = LimitTextFileReader.readTextFile(filePath);
                    if (fileContent != null) {
