...
//    	}
        ...
        try {
            ...
            BufferedReader memberReader = new BufferedReader(new FileReader("C:\\git\\Daitso\\member.txt"));
            BufferedWriter blacklistWriter = new BufferedWriter(new FileWriter("C:\\git\\Daitso\\blacklist.txt", true));
