...
public class SoldOut {
  ...
  private   String num; //번호
    ...
    public SoldOut(String num, String name, String category, String price, String transactionMethod, String paymentMethod, String status, String transactionData, String sellNum, String buyNum) {
        this.num = num;
        this.name = name;
